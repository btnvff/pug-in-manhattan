// Three.js r185 GLTFLoader and utilities, MIT (see three-LICENSE.txt).
// Sources: https://github.com/mrdoob/three.js/tree/r185/examples/jsm/
// Mechanical classic-script adapter only: imports/exports become scoped bindings.
(function (THREE) {
"use strict";
if (!THREE) return;
const {toTrianglesDrawMode} = (() => {
const {
	BufferAttribute,
	BufferGeometry,
